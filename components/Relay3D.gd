...
func stamp(
	...
	# The coil is a resistor between the signal and ground pins.
	var g_coil = 1.0 / max(coil_resistance, 1e-9)
	...
	CircuitGraph.stamp_conductance(A, g_coil, idx_sig, idx_gnd)
