...
func _build_mna_system(delta_time: float) -> Dictionary:
	...
	for comp_data in components:
		match comp_data.type:
			"Resistor":               _stamp_resistor(A, b, node_id_to_matrix_index, comp_data)
			"LED":                    _stamp_led(A, b, node_id_to_matrix_index, comp_data)
			"Diode":                  _stamp_diode(A, b, node_id_to_matrix_index, comp_data)
			"Switch":                 _stamp_switch(A, b, node_id_to_matrix_index, comp_data)
			"Potentiometer":          _stamp_potentiometer(A, b, node_id_to_matrix_index, comp_data)
			"PowerSource":            _stamp_power_source(A, b, node_id_to_matrix_index, comp_data, active_vs_id_to_matrix_index)
			"Battery":                _stamp_battery(A, b, node_id_to_matrix_index, comp_data, active_vs_id_to_matrix_index)
			"PolarizedCapacitor":     _stamp_polarized_cap(A, b, node_id_to_matrix_index, comp_data, delta_time)
			"NonPolarizedCapacitor":  _stamp_np_cap(A, b, node_id_to_matrix_index, comp_data, delta_time)
			"Inductor":               _stamp_inductor(A, b, node_id_to_matrix_index, comp_data, inductor_id_to_matrix_index, delta_time)
			"NPNBJT":                 _stamp_npnbjt(A, b, node_id_to_matrix_index, comp_data)
			"PNPBJT":                 _stamp_pnpbjt(A, b, node_id_to_matrix_index, comp_data)
			"NChannelMOSFET":         _stamp_nmos(A, b, node_id_to_matrix_index, comp_data, electrical_nodes)
			"ZenerDiode":             _stamp_zener(A, b, node_id_to_matrix_index, comp_data)
			"Relay":                  _stamp_relay(A, b, node_id_to_matrix_index, comp_data)
			_:                        pass
